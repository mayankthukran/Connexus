...
const SavedPosts = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4">
      {savedPosts.map((post) => (
        <div key={post.id} className="rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 flex flex-col">
          {/* Post Header */}
          <div className="flex items-center justify-between p-3 pb-2">
            <div className="flex items-center space-x-2">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center space-x-1 text-xs text-[#222831]">
                  <span className="truncate">{post.user.username}</span>
                </div>
              </div>
            </div>
            <button className="text-[#222831] hover:text-gray-500 flex-shrink-0">
          ...
          <div className="px-3 pb-2 flex-1">
            <p className="text-[#222831] text-sm leading-relaxed line-clamp-3">{post.content}</p>
          </div>
            ...
            <div className="flex items-center space-x-3">
              <button 
                ...
                className={`flex items-center space-x-1 transition-colors ${
                  post.isLiked ? 'text-red-500' : 'text-[#222831] hover:text-red-500'
                }`}
              >
              ...
              <button className="flex items-center space-x-1 text-[#222831] hover:text-green-500 transition-colors">
      ...
      <div className="col-span-full text-center py-6">
        <button className="bg-[#393E46] hover:bg-[#948979] text-white px-6 py-2 rounded-lg transition-colors">
